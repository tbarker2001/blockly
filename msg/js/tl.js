...
Blockly.Msg.GYRO_TOOLTIP_ORB = "Represents a tilt sensor.";  // untranslated
...
Blockly.Msg.SENSOR_GYRO_ORB = "tilt sensor";  // untranslated
Blockly.Msg.SENSOR_GYRO_TILTED_GETSAMPLE_TOOLTIP_ORB = "Is the tilt sensors position the indicated manner?";  // untranslated
...
Blockly.Msg.SENSOR_INFRARED_DISTANCE_GETSAMPLE_TOOLTIP_ORB = "Gets the current relative distance from the infrared sensor. The values are between 1, close, and 10, further away.";  // untranslated
